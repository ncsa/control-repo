...
mod 'ncsa/profile_acctd', tag: 'v1.1.2', git: 'https://github.com/ncsa/puppet-profile_acctd'
mod 'ncsa/profile_additional_packages', tag: 'v0.4.0', git: 'https://github.com/ncsa/puppet-profile_additional_packages'
...
mod 'ncsa/profile_slurm', tag: 'v1.2.3', git: 'https://github.com/ncsa/puppet-profile_slurm.git'
...
mod 'ncsa/profile_update_os', tag: 'v0.3.8', git: 'https://github.com/ncsa/puppet-profile_update_os'
mod 'ncsa/profile_user_environment', tag: 'v0.1.2', git: 'https://github.com/ncsa/puppet-profile_user_environment'
