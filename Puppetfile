...
mod 'ncsa/profile_secrets', tag: 'v0.0.5', git: 'https://github.com/ncsa/puppet-profile_secrets'
...
mod 'ncsa/profile_system_auth', tag: 'v0.3.5', git: 'https://github.com/ncsa/puppet-profile_system_auth'
...
mod 'southalc-vault_secrets', '0.3.2'
mod 'thrnio/ip', '1.0.1'
