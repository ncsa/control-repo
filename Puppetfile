...
mod 'ncsa/profile_update_os', tag: 'v0.3.0', git: 'https://github.com/ncsa/puppet-profile_update_os'
mod 'ncsa/profile_virtual', tag: 'v0.1.1', git: 'https://github.com/ncsa/puppet-profile_virtual'
mod 'ncsa/profile_website', tag: 'v0.1.0', git: 'https://github.com/ncsa/puppet-profile_website'
