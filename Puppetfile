...
mod 'ncsa/gpfs', tag: 'v2.1.3', git: 'https://github.com/ncsa/puppet-spectrumscale.git'
...
mod 'ncsa/profile_audit', tag: 'v0.1.11', git: 'https://github.com/ncsa/puppet-profile_audit'
mod 'ncsa/profile_dns_cache', branch: 'jhaney/SVCPLAN-1814/resolv.conf-symlink-unbound-managed-not-NetworkManager', git: 'https://github.com/ncsa/puppet-profile_dns_cache'
...
mod 'ncsa/telegraf', tag: 'ncsa/v0.1.0', git: 'https://github.com/ncsa/puppet-telegraf.git'
