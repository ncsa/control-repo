...
mod 'ncsa/profile_email', tag: 'v0.2.0', git: 'https://github.com/ncsa/puppet-profile_email'
...
mod 'ncsa/sssd', ASDPLNG-68tag: 'v3.0.0', git: 'https://github.com/ncsa/puppet-sssd'
...
mod 'puppetlabs/southalc-podman', '0.2.7'
