...
mod 'ncsa/gpfs', tag: 'v2.1.6', git: 'https://github.com/ncsa/puppet-spectrumscale.git'
...
mod 'ncsa/profile_email', tag: 'v0.2.4', git: 'https://github.com/ncsa/puppet-profile_email'
...
mod 'ncsa/sshd', tag: 'v0.4.0', git: 'https://github.com/ncsa/puppet-sshd'
