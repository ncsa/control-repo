...
mod 'ncsa/profile_acctd', tag: 'v1.1.3', git: 'https://github.com/ncsa/puppet-profile_acctd'
...
mod 'ncsa/profile_backup', tag: 'v0.0.5', git: 'https://github.com/ncsa/puppet-profile_backup'
...
mod 'ncsa/profile_rsyslog', tag: 'v0.2.0', git: 'https://github.com/ncsa/puppet-profile_rsyslog'
...
mod 'ncsa/profile_xcat', tag: 'v1.1.8', git: 'https://github.com/ncsa/puppet-profile_xcat.git'
