...
mod 'ncsa/profile_gpu', tag: 'v1.0.3', git: 'https://github.com/ncsa/puppet-profile_gpu.git'
...
mod 'ncsa/profile_lustre', tag: 'v2.0.0',  git: 'https://github.com/ncsa/puppet-profile_lustre'
