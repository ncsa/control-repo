...
mod 'ncsa/profile_audit', tag: 'v0.1.0', git: 'https://github.com/ncsa/puppet-profile_audit'
...
mod 'ncsa/profile_firewall', tag: 'v1.0.4', git: 'https://github.com/ncsa/puppet-profile_firewall'
...
mod 'ncsa/profile_rsyslog', tag: 'v0.1.2', git: 'https://github.com/ncsa/puppet-profile_rsyslog'
...
mod 'ncsa/profile_system_auth', tag: 'v0.3.0', git: 'https://github.com/ncsa/puppet-profile_system_auth'
