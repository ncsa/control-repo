...
mod 'ncsa/profile_audit', tag: 'v0.1.10', git: 'https://github.com/ncsa/puppet-profile_audit'
...
mod 'ncsa/profile_lustre', tag: 'v1.3.0', git: 'https://github.com/ncsa/puppet-profile_lustre.git'
